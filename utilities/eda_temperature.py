# EDA for TEMPERATURE C: summary stats, correlation with NO2, seaborn plots (hist + scatterplot).
...
# Right: scatterplot Temperature vs NO2
sns.scatterplot(x=temp, y=no2, ax=ax[1], alpha=0.6)
ax[1].set_title("NO2 vs Temperature")
